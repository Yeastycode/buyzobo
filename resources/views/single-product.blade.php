                    ...
                    <div class="col-lg-12">
                        <div class="product_img_slide owl-carousel">
                            <div class="single_product_img">
                                <img src="{{asset('assets/img/gallery/gallery1.png')}}" alt="#" class="img-fluid">
                            </div>
                            <div class="single_product_img">
                                <img src="{{asset('assets/img/gallery/gallery01.png')}}" alt="#" class="img-fluid">
                            </div>
                            <div class="single_product_img">
                                <img src="{{asset('assets/img/gallery/gallery1.png')}}" alt="#" class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="single_product_text text-center">
                            ...
                            <p>
                                ...
                                competencies vis-a-vis impactful experiences. Dramatically synthesize integrated
